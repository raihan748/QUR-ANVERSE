...
export const MASTER_TAJWEED_ENCYCLOPEDIA: TajweedEncyclopediaEntry[] = [
  ...
  },
  {
    ...
    pengertianIstilah: 'Membaca huruf Lam pada lafadz jalalah (اللَّه) dengan meninggikan pangkal lidah ke langit-langit atas sehingga mulut penuh dengan gaung suara tebal.',
    sebabHukum: 'Pengaruh harakat Fathah atau Dhommah yang kuat sebelum nama Allah.',
    summary: 'Lafadz Allah dibaca tebal/gemuk saat didahului harakat Fathah atau Dhommah.',
    caraBaca: 'Ucapkan "ALLAH" dengan suara tebal dan bulat (bukan tipis "ellah").',
    contohLafadz: 'قُلْ هُوَ ٱللَّهُ أَحَدٌ • نَصْرُ ٱللَّهِ • قَالَ ٱللَّهُ • عَبْدُ ٱللَّهِ'
  },
  {
    id: 'enc-lam-tarqiq',
    ...
    pengertianIstilah: 'Membaca huruf Lam pada lafadz jalalah (اللَّه) dengan menurunkan pangkal lidah ke dasar mulut sehingga tidak menghasilkan gaung tebal.',
    sebabHukum: 'Pengaruh harakat Kasrah yang memiliki sifat istifal dan miring ke bawah.',
    summary: 'Lafadz Allah dibaca tipis dan bersih saat didahului harakat Kasrah.',
    caraBaca: 'Ucapkan "LILLAH" secara tipis dan mengalir jernih.',
    contohLafadz: 'بِسْمِ ٱللَّهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ • فِى دِينِ ٱللَّهِ • قُلِ ٱللَّهُمَّ'
  },
  {
    id: 'enc-ra-tafkhim',
    title: 'Ra Tafkhim (Ra Tebal)',
    arabicName: 'رَاء تَفْخِيم',
    category: 'Lam & Ra',
    letters: 'Ra berharakat Fathah (رَ), Dhommah (رُ), atau Ra Sukun (رْ) didahului Fathah/Dhommah',
    harakat: '1 Harakat (Getaran Tebal)',
    colorHex: '#D97706',
    pengertianBahasa: 'Tafkhim berarti menebalkan suara.',
    pengertianIstilah: 'Membaca huruf Ra dengan menaikkan pangkal lidah ke langit-langit sehingga menghasilkan getaran suara yang tebal dan berisi di rongga mulut.',
    sebabHukum: 'Karakter fonetik vokal atas (fathah/dhommah) yang menguatkan sifat Ra.',
    summary: 'Huruf Ra dibaca tebal pada harakat Fathah, Dhommah, atau sukun setelahnya.',
    caraBaca: 'Bunyikan getaran huruf Ra secara tegas, tebal, dan memenuhi mulut.',
    contohLafadz: 'رَبَّنَا • رُزِقْنَا • مَرْيَمَ • قُرْءَانٌ • ٱرْجِعِى'
  },
  {
    id: 'enc-ra-tarqiq',
    title: 'Ra Tarqiq (Ra Tipis)',
    arabicName: 'رَاء تَرْقِيق',
    category: 'Lam & Ra',
    letters: 'Ra berharakat Kasrah (رِ) atau Ra Sukun (رْ) didahului Kasrah Asli',
    harakat: '1 Harakat (Getaran Lembut)',
    colorHex: '#2563EB',
    pengertianBahasa: 'Tarqiq berarti menipiskan suara.',
    pengertianIstilah: 'Membaca huruf Ra dengan merendahkan pangkal lidah sehingga getaran suara mengalir tipis, lembut, dan ringan di bibir.',
    sebabHukum: 'Pengaruh harakat Kasrah yang menarik lidah ke bawah.',
    summary: 'Huruf Ra dibaca tipis dan ringan pada harakat Kasrah atau sukun setelah Kasrah asli.',
    caraBaca: 'Bunyikan getaran huruf Ra dengan halus tanpa memoncongkan bibir.',
    contohLafadz: 'رِجَالٌ • فِرْعَوْنَ • قَدِيرٌ ۝ • مِرْيَةٍ'
  },
  {
    ...
    category: 'Lam & Ra',
    letters: 'Ra sukun setelah kasrah bertemu huruf Isti\'la berharakat kasrah (فِرْقٍ)',
    harakat: '1 Harakat (Boleh Tafkhim / Tarqiq)',
    colorHex: '#7C3AED',
    pengertianBahasa: 'Jawazul Wajhain berarti diperbolehkannya dua cara membaca.',
    ...
    summary: 'Pilihan membaca tebal atau tipis pada kata khusus seperti فِرْقٍ (QS. Asy-Syu\'ara: 63).',
    caraBaca: 'Boleh dibaca tebal (Tafkhim) atau tipis (Tarqiq) saat washal, dan keduanya sah.',
    contohLafadz: 'فَكَانَ كُلُّ فِرْقٍ كَٱلطَّوْدِ ٱلْعَظِيمِ • عَيْنَ ٱلْقِطْرِ • مِصْرَ'
  },
